...
const Page = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-t from-slate-100">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl p-6">
        ...
        <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg" style={{ height: "620px" }} >
  ...
  loading && (
    <button
      className="w-full py-3 bg-red-500 rounded-lg flex items-center mt-9 justify-center"
      disabled
    >
      <Loader className="animate-spin text-white h-6 w-6" />
        ...
        <div className="hidden md:block text-center">
         ...
         <h1 className="text-5xl font-extrabold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-teal-400 animate__animated animate__fadeInRight">
  Welcome to Sea View Immigration!
</h1>

<p  className=" text-xl font-extrabold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-teal-400 animate__animated animate__fadeInRight">
