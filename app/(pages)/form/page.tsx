  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submissionData = {
        ...
        previousVisaDetails: formData.previousVisaDetails,
        ...
        personalDetails: {
          ...
          dateOfBirth: formData.applicantInfo.dob,
          placeOfBirth: formData.applicantInfo.placeOfBirth,
          colorOfEyes: formData.applicantInfo.eyeColor,
          height: {
            inches: formData.applicantInfo.height,
            cm: formData.applicantInfo.height, // You might want to convert this
          },
          gender: formData.applicantInfo.gender,
          telephone: formData.applicantInfo.telephone,
          email: formData.applicantInfo.email,
          statusInCanada: formData.applicantInfo.statusInCanada,
          currentAddress: formData.applicantInfo.currentAddress,
          homeCountryAddress: formData.applicantInfo.homeCountryAddress,
        },

        // Passport details
        passportDetails: {
          passportNumber: formData.applicantInfo.passportNumber,
          issueDate: formData.applicantInfo.passportIssueDate,
          expiryDate: formData.applicantInfo.passportExpiryDate,
          countryOfIssue: formData.applicantInfo.passportCountry,
        },
        ...
        // Spouse details
        spouseDetails: {
          dateOfMarriage: formData.spouseInfo.marriageDate,
          firstName: formData.spouseInfo.firstName,
          lastName: formData.spouseInfo.lastName,
          dateOfBirth: formData.spouseInfo.dob,
          placeOfBirth: formData.spouseInfo.placeOfBirth,
          occupation: formData.spouseInfo.occupation,
          address: formData.spouseInfo.address,
        },

        // Previous marriage
        previousMarriage: {
          marriageDate: formData.previousMarriage.marriageDate,
          endDate: formData.previousMarriage.endDate,
          spouseFirstName: formData.previousMarriage.spouseFirstName,
          spouseLastName: formData.previousMarriage.spouseLastName,
          spouseDob: formData.previousMarriage.spouseDob,
        },

        // Parents info
        fatherDetails: {
          firstName: formData.parentsInfo.father.firstName,
          lastName: formData.parentsInfo.father.lastName,
          dateOfBirth: formData.parentsInfo.father.dob,
          placeOfBirth: formData.parentsInfo.father.placeOfBirth,
          occupation: formData.parentsInfo.father.occupation,
          currentAddress: formData.parentsInfo.father.address,
          deceased: !!formData.parentsInfo.father.dateOfDeath,
          dateOfDeath: formData.parentsInfo.father.dateOfDeath,
        },

        motherDetails: {
          firstName: formData.parentsInfo.mother.firstName,
          lastName: formData.parentsInfo.mother.lastName,
          dateOfBirth: formData.parentsInfo.mother.dob,
          placeOfBirth: formData.parentsInfo.mother.placeOfBirth,
          occupation: formData.parentsInfo.mother.occupation,
          currentAddress: formData.parentsInfo.mother.address,
          deceased: !!formData.parentsInfo.mother.dateOfDeath,
          dateOfDeath: formData.parentsInfo.mother.dateOfDeath,
        },
        ...
        // Children details
        childrenDetails: formData.children.map(child => ({
          ...
          height: {
            feet: child.heightFeet,
            inches: child.heightInches,
          },
        })),

        // Siblings
        siblingDetails: formData.siblings.map(sibling => ({
          firstName: sibling.name.split(' ')[0],
          lastName: sibling.name.split(' ')[1] || '',
        ...
        // Address history
        addressHistory: formData.addressHistory.map(addr => ({
          from: addr.fromDate,
          to: addr.toDate,
          address: addr.address,
          cityState: addr.cityState,
          country: addr.country,
          activity: addr.currentStatus,
        })),
        ...
        // Relatives in Canada
        relativesInCanada: formData.relativesInCanada.map(relative => ({
          firstName: relative.firstName,
          lastName: relative.lastName,
          address: relative.address,
          relation: relative.relation,
          statusInCanada: relative.status,
          yearsInCanada: relative.yearsInCanada,
        })),

        // IELTS scores
        ieltsScores: {
          listening: formData.ieltsScores.listening,
          reading: formData.ieltsScores.reading,
          writing: formData.ieltsScores.writing,
          speaking: formData.ieltsScores.speaking,
          overall: formData.ieltsScores.overall,
        },

        // Additional questions
        additionalQuestions: {
          criminalRecord: formData.questions.crime.answer === 'yes',
          previousVisaRefusal: formData.questions.visa.answer === 'yes',
          medicalIssues: formData.questions.health.answer === 'yes',
          notes: [
            formData.questions.crime.details,
            formData.questions.visa.details,
            formData.questions.health.details
          ].filter(Boolean).join(' | '),
        },
      };
