...
export default function Form() {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (type === 'checkbox') {
            // Handle checkboxes (like application type)
            setFormData(prev => ({
                ...prev,
            ...
            setFormData(prev => {
                ...
                return {
                    ...prev,
                    addressHistory: updatedAddressHistory
                };
            });
            ...
            setFormData(prev => {
                ...
                return {
                    ...prev,
                    relativesInCanada: updatedRelatives
                };
            });
        } else {
