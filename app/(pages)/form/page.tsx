    ...
    return (    
        <div style={{ fontFamily: raleway.style.fontFamily }} className="w-full text-gray-500"> 
            ...
            <div className="page-container pt-[140px] pb-10 pl-10 pr-10">
                ...
                {/* Page 2 */}
                {page === 2 && (
                   <div id="page2" className="page2 pb-10 pl-10 pr-10">
                   <h2 className="text-4xl mb-10">Applicant Information</h2>
                ...
                {/* Page 3 */}
                {page === 3 && (
    <div id="page3" className="page3  pb-10 pl-10 pr-10">
        <h3 className="text-4xl mb-4">Spouse/Common Law Partner Information</h3>
        ...
        <div className="previous-marriage-info space-y-6 mb-10">
            ...
            <div className="flex space-x-4">
                ...
                {/* Page 4 */}
                {page === 4 && (
    <div id="page4" className="page4 mb-10">
        <h2 className="text-4xl mb-10">Parental Information</h2>
        ...
        <div className=" p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Page 5 */}
                {page === 5 && (
                <div id="page5" className="page5 mb-10">
                    <h2 className="text-4xl mb-10">Education and Work History</h2>
                            ...
                            <tbody>
                                {educationRows.map((row) => (
                                    <tr key={row.id} className="border-b">
                                        <td className="p-2"><input type="date" className="w-full p-1 border rounded-md" /></td>
                                        <td className="p-2"><input type="date" className="w-full p-1 border rounded-md" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Institute Name" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="City" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Course" /></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                {workRows.map((row) => (
                                    <tr key={row.id} className="border-b">
                                        <td className="p-2"><input type="date" className="w-full p-1 border rounded-md" /></td>
                                        <td className="p-2"><input type="date" className="w-full p-1 border rounded-md" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Designation" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Job Duties" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="City" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Country" /></td>
                                        <td className="p-2"><input type="text" className="w-full p-1 border rounded-md" placeholder="Company Name" /></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                {/* Page 6 */}
                {page === 6 && (
                <div id="page6" className="page6 mb-10">
                    <h2 className="text-4xl mb-10">Additional Information</h2>
                    ...
                    <div className="mb-10">
                        ...
                        {childrenRows.map((row) => (
                            <div key={row.id} className="mb-6 p-4 border-b border-gray-300">
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-3">
                                    ...
                                    <div className="flex space-x-2">
                                        <input type="number" className="w-1/2 p-2 border rounded-md" placeholder="Feet" />
                                        <input type="number" className="w-1/2 p-2 border rounded-md" placeholder="Inches" />
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                {page === 7 && (
                <div id="page7" className="page7 mb-10">
                    <h2 className="text-4xl mb-10">Additional Information</h2>

                    {/* Address History */}
                    <div className="mb-10">
                        <h3 className="text-2xl  mb-4 ">Address of Places the Main Applicant Has Lived Since 18th Birthday</h3>
                    ...
                    {/* Travel History */}
                    <div className="mb-10">
                        <h3 className="text-2xl  mb-4 ">Travel History - Details of Travel Outside Country of Residence & Origin</h3>
               ...
               {page === 8 && (
                <div id="page8" className="page8 mb-10">
                    <h2 className="text-4xl mb-10">Additional Information</h2>

                    {/* Relatives in Canada */}
                    <div className="mb-10">
                        <h3 className="text-2xl  mb-4 ">Relatives in Canada (If any)</h3>
                    ...
                    {/* IELTS Scores */}
                    <div className="mb-10">
                        <h3 className="text-2xl  mb-4 ">IELTS Score for Each Module</h3>
                    ...
                    {/* Important Questions */}
                    <div className="mb-10">
                        <h3 className="text-2xl  mb-4 ">Please Read the Following and Answer Carefully</h3>
          ...
          <button className="border-[#155da9] border-2 mt-8 text-[#155da9] px-10 py-4 tracking-wide hover:bg-[#155da9] hover:text-white transition-transform duration-500 hover:-translate-y-3 rounded-full">
            ...
            {/* <div className="pb-10">
                <Pagination>
                    <PaginationContent>
                        <PaginationItem>
                            {page > 1 && <PaginationPrevious href="" onClick={() => setPage(page - 1)} />}
                        </PaginationItem>
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((pageNum) => (
                            <PaginationItem key={pageNum}>
                                <PaginationLink 
                                    onClick={() => setPage(pageNum)} 
                                    className={page === pageNum ? 'bg-[#155da9] text-white' : 'text-black'}
                                >
                                    {pageNum}
                                </PaginationLink>
                            </PaginationItem>
                        ...
                        <PaginationItem>
                            {page < 7 && <PaginationNext href="" onClick={() => setPage(page + 1)} />}
                        </PaginationItem>
                    </PaginationContent>
                </Pagination>
            </div> */}   
