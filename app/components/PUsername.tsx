      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden w-full max-w-md">
        ...
        <div className="p-8 flex flex-col items-center">
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <Link href="https://www.google.com/maps/place/SEAVIEW+IMMIGRATION+SERVICES+LTD./@62.6573279,-95.989235,3z/data=!4m8!3m7!1s0x5485db7e7b9362af:0x452379f030e0fecd!8m2!3d62.6573279!4d-95.989235!9m1!1b1!16s%2Fg%2F11t7jjysgm?entry=ttu&g_ep=EgoyMDI1MDMyNS4xIKXMDSoASAFQAw%3D%3D"
