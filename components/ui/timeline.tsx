  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-6xl mb-4 text-[#155da9] font-normal max-w-4xl">
        ...
        {data.map((item, index) => (
          <div key={index} className="flex flex-col md:flex-row items-start gap-10 pt-10 md:pt-40">
            ...
            <div className="sticky top-40 z-40 flex flex-col md:flex-row items-center md:w-1/3">
              ...
              <h3 className="hidden md:block  text-xl md:pl-8 md:text-3xl font-semibold text-[#155da9]">
                {item.title}
              </h3>
            </div>
